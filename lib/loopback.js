 ...
 * registry, can rewrite a global package installation, restore snapshots over
 * the live install, and end this process — so a LAN-exposed `dsh web` must
 * not serve them to anyone but the machine's own browser.
 *
